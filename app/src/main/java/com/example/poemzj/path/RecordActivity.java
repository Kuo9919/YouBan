...
import com.example.poemzj.map.RouteActivity;
import com.example.poemzj.map.SearchActivity;
...
public class RecordActivity extends AppCompatActivity implements AMap.OnPOIClickListener,
    ...
    private void checkPermission() {
        ...
        if (ContextCompat.checkSelfPermission(RecordActivity.this, Manifest.permission.
        ...
        if (!permissionList.isEmpty()) {
            ...
            ActivityCompat.requestPermissions(RecordActivity.this, permissions, 1);
        }
        else {
            init();
        }
        ...
        switch (v.getId()) {
            ...
            case R.id.fab_plan:
                if (marker != null) {
                    ...
                    RouteActivity.startActivity(RecordActivity.this, curLocation, null, null, city);
                }
                break;
            case R.id.search:
                SearchActivity.startActivity(RecordActivity.this,
                ...
                if (grantResults.length > 0) {
                    for (int result : grantResults) {
                        if (result != PackageManager.PERMISSION_GRANTED) {
                            Toast.makeText(RecordActivity.this, "You denied the permission",
                    ...
                    Toast.makeText(RecordActivity.this, "Unknown mistake",
                            Toast.LENGTH_SHORT).show();
                    finish();
                }
                break;
